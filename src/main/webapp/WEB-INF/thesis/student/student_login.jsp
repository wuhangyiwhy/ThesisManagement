						...
						<div class="layui-form layui-form-pane">
							<form method="post" >
								<div class="layui-form-item">
									<label for="L_xh" class="layui-form-label" >学号</label>
									<div class="layui-input-inline">
										<input type="text" id="L_xh" name="xh"  required=""
											lay-verify="xh" autocomplete="off" class="layui-input" />
									</div>
								</div>
								<div class="layui-form-item">
									<label for="L_xm" class="layui-form-label">姓名</label>
									<div class="layui-input-inline">
										<input type="text" id="L_loginName" name="xm"
											required=""  lay-verify="xm" autocomplete="off"
											class="layui-input" />
									</div>
								</div>
								<div class="layui-form-item">
									<label for="L_sfzh" class="layui-form-label">身份证号</label>
									<div class="layui-input-inline">
										<input type="text" id="L_sfzh" name="sfzh" required=""
											lay-verify="sfzh" autocomplete="off" class="layui-input" />
									</div>
								</div>
								<div class="layui-form-item">
								...
								<div class="layui-form-item">
									<button class="layui-btn" lay-submit="" lay-filter="xsd">立即登录</button>
...
<div class="fly-footer"> 
	...
	<script>
		...
		layui.use(['form', 'layedit', 'laydate'], function(){
			...
			/*   form.verify({
			  ...
			  form.on('submit(xsd)', function(data){
				  $.ajax({   
	                  url:'${pageContext.request.contextPath}/student/dologin',       
	                  method:'post',       
	                  data:data.field,        
	                  dataType:'JSON',         
	  ...
	                      if(res.code==0){ 
		        			layer.msg(res.msg);
		  					window.location.href="${pageContext.request.contextPath}/student/myinfo";
	                      }else            
	                        layer.msg(res.msg);   
	                      },               
	                  error:function (data) { }           
